...
HU = 50; % a number of hidden neurons
...
EPOCH=100; % a number of training epochs
LAMBDA=1.0; % learning rate
...
print -dpng "day4/exercise4_2.png";

save day4/exercise4_2.txt train_res_mat train_accuracy test_res_mat test_accuracy;
